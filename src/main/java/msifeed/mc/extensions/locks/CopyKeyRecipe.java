...
import msifeed.mc.extensions.locks.items.BlankKeyItem;
import msifeed.mc.extensions.locks.items.KeyItem;
...
public class CopyKeyRecipe implements IRecipe {
    private final Item key = GameRegistry.findItem(Bootstrap.MODID, KeyItem.ID);
    private final Item blank_key = GameRegistry.findItem(Bootstrap.MODID, BlankKeyItem.ID);
